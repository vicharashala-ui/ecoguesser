...
//
// Hamburger renders on every tab, including Daily -- SideDrawer renders
// Category/Region & State there too (greyed out, since Daily's site pool
// is fixed) so the drawer stays visually consistent across modes.
//
